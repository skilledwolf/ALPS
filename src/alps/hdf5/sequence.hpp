...
// Resizable indexed sequences share their shape and archive representation.
// Container specializations supply traits; packed vector<bool> keeps its adapter.
template<class Sequence> struct sequence_get_extent {
...
template<class Sequence> struct sequence_set_extent {
...
template<class Sequence> struct sequence_is_vectorizable {
...
template<class Sequence> void load_sequence(archive& ar, std::string const& path, Sequence& value,
