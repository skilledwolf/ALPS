...
The hybridization solver is built with the ALPS applications as the executable \verb#hybridization#. Follow the current build instructions in \verb#CONTRIBUTING.md# at the repository root; the adjacent \verb#README.md# links to the build guide and Python tutorials. Source builds require CMake 3.27 or newer and the documented ALPS dependencies. Configure with \verb#ALPS_BUILD_APPLICATIONS=ON# and build the \verb#hybridization# and \verb#p2h5# targets.
